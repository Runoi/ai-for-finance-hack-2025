"""
Модуль для мониторинга и управления ресурсами.

Предоставляет синглтон-класс `ResourceManager` для отслеживания времени выполнения,
стоимости API-вызовов, а также пикового и текущего потребления CPU/RAM.
"""
