...
def _create_concept_graph(docs: List[Document], embeddings: Embeddings):
    ...
    stop_words = [
    # Общие (предлоги, союзы, местоимения, частицы)
    "а", "без", "более", "больше", "бы", "был", "была", "были", "было", "быть", 
    "в", "вам", "вас", "ведь", "весь", "вместо", "вне", "внизу", "внутри", "во", 
    "вокруг", "вот", "впрочем", "все", "всегда", "всего", "всех", "всю", "вы", 
    "где", "да", "даже", "для", "до", "друг", "его", "ее", "ей", "ему", "если", 
    "есть", "еще", "ж", "же", "за", "зачем", "здесь", "и", "из", "из-за", "или", 
    "им", "иметь", "иногда", "их", "к", "как", "какая", "какие", "какого", "какое", 
    "какой", "каком", "какую", "когда", "конечно", "которая", "которого", "которой", 
    "котором", "которую", "которые", "который", "которых", "кто", "куда", "ли", 
    "либо", "лишь", "лучше", "между", "меня", "мне", "много", "может", "можно", 
    "мои", "мой", "моя", "мое", "мы", "на", "над", "надо", "наконец", "нас", "не", 
    "него", "нее", "ней", "нельзя", "нему", "нет", "ни", "никогда", "ничего", "них", 
    "но", "ну", "о", "об", "однако", "один", "она", "они", "оно", "опять", "от", 
    "очень", "по", "под", "после", "потом", "потому", "почти", "при", "про", "раз", 
    "разве", "сам", "сама", "сами", "самого", "самом", "саму", "свое", "своего", 
    "своей", "своем", "свои", "своих", "свою", "с", "себе", "себя", "сейчас", "со", 
    "совсем", "так", "также", "такие", "такой", "там", "тебя", "тем", "теперь", 
    "то", "тогда", "того", "тоже", "той", "только", "том", "тот", "точнее", "ты", 
    "у", "уже", "хорошо", "хоть", "чего", "чей", "чем", "через", "что", "чтоб", 
    "чтобы", "чья", "чье", "чьи", "чуть", "эта", "эти", "этим", "этих", "это", 
    "этого", "этой", "этом", "эту", "я",

    # Из нашего топ-100 (исключая потенциально полезные)
    "три", "личный", "случае", "дело", "заявление", "нем", "перед", "условиях", 
    "получите", "многие", "другие", "вашем", "именно", "счета", "придется", "ваш", 
    "закону", "затем", "узнать", "другим", "люди", "несколько", "компании", "каких", 
    "сколько", "клиентов", "рублей", "числе", "других", "вашего", "меньше", "данные", 
    "некоторые", "тех", "отказаться", "обновлено", "другой", "интернет", "прежде", 
    "свой", "вправе", "одного", "два", "года", "информацию", "будете", "месяца", 
    "россии", "смогут", "которым", "сможет", "каждого", "год", "часть", "причем", 
    "помощью", "услуги", "рассчитывать", "сумму", "течение", "онлайн", "сайте", 
    "могут", "ваших", "лет", "месяц", "банка", "дней", "суммы", "человек", "можете", 
    "должны", "получится", "примеру", "читайте", "важно", "просто", "покупки", 
    "внимание", "тексте", "проще", "денег", "ним", "удастся", "всем", "ситуации", 
    "имеют", "ваше", "хотя", "таких"
]
    
    vectorizer = TfidfVectorizer(max_features=1000, stop_words=stop_words, ngram_range=(1,2))
